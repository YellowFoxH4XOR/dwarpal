...
var explainTable = map[string]explainEntry{
	"max-lines": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/diff-budget#max-lines",
	},
	"max-files": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/diff-budget#max-files",
	},
	"max-new-files": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/diff-budget#max-new-files",
	},
	"protected-branch": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/branch-policy#protected-branch",
	},
	"out-of-scope": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/scope#out-of-scope",
	},
	"no-task-manifest": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/scope#no-task-manifest",
	},
	"below-threshold": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/diff-coverage#below-threshold",
	},
	"no-new-lint-suppressions": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/ai-patterns#no-new-lint-suppressions",
	},
	"no-hardcoded-secrets/private-key": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/ai-patterns#no-hardcoded-secrets",
	},
	...
	"no-sql-concat": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/ai-patterns#no-sql-concat",
	},
	"no-broad-catch": {
		...
		DocsURL: "https://docs.dwarpal.dev/gates/ai-patterns#no-broad-catch",
	},
}
